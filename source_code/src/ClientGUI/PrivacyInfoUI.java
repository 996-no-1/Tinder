...
public class PrivacyInfoUI {
	...
	private void initialize() {
		...
		btnDiscard.setBounds(73, 313, 113, 27);
		frmTinderPrivacy.getContentPane().add(btnDiscard);

		btnSubmit = new JButton("Submit");
		btnSubmit.setBounds(294, 313, 113, 27);
		frmTinderPrivacy.getContentPane().add(btnSubmit);
	...
	private void JumpPage() {
		frmTinderPrivacy.setVisible(false);
