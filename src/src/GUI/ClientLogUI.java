...
public class ClientLogUI {
	...
	private JRadioButton dhSelect;
	private JRadioButton rsaSelect;
	...
	private void initialize() {
		...
		rsaSelect = new JRadioButton("RSA");
		rsaSelect.setSelected(true);
		rsaSelect.setBounds(133, 204, 63, 27);
		frmLogPage.getContentPane().add(rsaSelect);

		dhSelect = new JRadioButton("DH");
		dhSelect.setBounds(239, 204, 63, 27);
		frmLogPage.getContentPane().add(dhSelect);
		mode.add(dhSelect);
		mode.add(rsaSelect);
		...
		saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (event.equals(signInBtn)) {
					...
					if (rsaSelect.isSelected()) {
						chatApplication.setAsMode("RSA");
					} else {
						chatApplication.setAsMode("DH");
					}
